      ...
      <div className="container main-secction">
        <div className="row">
          <div className="col-md-12 col-sm-12 col-xs-12 image-section">
            <img src="https://images.pexels.com/photos/630754/autumn-orange-nature-red-630754.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" />
          </div>
              ...
              <div className="row ">
                <div className="col-md-12 col-md-12-sm-12 col-xs-12 user-image text-center">
                  {dataAccount.img ?
                    ...
                    <i style={{ fontSize: '30px' }} class="fa fa-user-circle-o" aria-hidden="true"></i>
                  }
                </div>
                <div className="col-md-12 col-sm-12 col-xs-12 user-detail-section1 text-center">
                  <button id="btn-contact" onClick={() => clearModal()} data-toggle="modal" data-target="#contact" className="btn btn-success btn-block follow">Đổi mật khẩu</button>
                ...
                <div className="row user-detail-row">
                  <div className="col-md-12 col-sm-12 user-detail-section2 pull-left">
                    ...
                    <span>5/5</span> <i class="fa fa-star" style={{ color: 'gold', fontSize: '15px' }} aria-hidden="true"></i>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div className="col-md-8">
                      <ul className="nav nav-tabs" role="tablist">
                        <li className="nav-item">
                          <a className="nav-link active" href="#profile" role="tab" data-toggle="tab"><i class="fa fa-user" aria-hidden="true"></i> Thông tin người dùng</a>
                        </li>
                        <li className="nav-item">
                          <a className="nav-link" href="#buzz" role="tab" data-toggle="tab"><i class="fa fa-list-alt" aria-hidden="true"></i> Đơn đặt</a>
                        </li>
                      </ul>
                      {/* Tab panes */}
        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="contact">Đổi mật khẩu</h5>
