        ...
        <>
            <div className="container-fluid" style={{ height: '1800px' }}>
                <div className="d-sm-flex align-items-center justify-content-between mb-4">
                    <h5 className=" mb-0 text-gray-800">{`Chi tiết nhà hàng ${item.restaurantName !== null && item.restaurantName !== undefined
                        ? item.restaurantName
                        : ""
                        }`}</h5>
                    <Button
                ...
                <div className=" background-detail-custom  shadow " >
                    <Descriptions size="small" layout="horizontal" bordered>
                        ...
                        <Descriptions.Item label="Thuộc nhà hàng" span={3}>
                            {item.rate && item.rate} <i style={{ color: 'gold' }} class="fa fa-star" aria-hidden="true"></i>
                        </Descriptions.Item>
                        ...
                        <Descriptions.Item label="Link map" span={3}>
                            <iframe src={item.map} width="300" height="250" style={{ border: '0' }} allowfullscreen="" loading="lazy"></iframe>
                        </Descriptions.Item>
                        <Descriptions.Item label="Tất cả ảnh" span={3}>
                            <div className="row ">
                                <div className="col-md-12 restaurant1">
                                    <Image src={item.img} style={{ width: '100%', height: '260px', borderRadius: '7px' }} />
                                </div>
                                <div className="col-md-12 highlight-restaurant">
                                    {Array.isArray(item.img1) && item.img1.length > 0 && item.img1.map((item, index) => {
                                        if (item) {
                                            return (
